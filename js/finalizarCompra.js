...
function cuentaUI(){
     ...
     $('#cuentaProductos').append(registroCarrito(precioSubtotal, imp, total(precioSubtotal, imp)));
}
...
function registroCarrito(subtotal, imp, total){
     return    `<div class="cuentas">
                    ...
                    <button id="btn-confirmar" class="btn btn-confirmacionCompra">Confirmar compra</button>
